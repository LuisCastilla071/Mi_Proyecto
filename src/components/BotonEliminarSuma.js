...
const BotonEliminarSuma = ({ id, recargarDatos }) => {
  ...
  const confirmarEliminar = async () => {
    try {
      ...
      console.error("Error al eliminar suma:", error);
    }
  };
      ...
      <Modal visible={visible} transparent animationType="fade" onRequestClose={() => setVisible(false)}>
        <View style={styles.overlay}>
          <View style={styles.modal}>
            <Text style={styles.texto}>¿Eliminar esta suma?</Text>
...
export default BotonEliminarSuma;